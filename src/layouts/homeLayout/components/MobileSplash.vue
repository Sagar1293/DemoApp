	...
	<section>
		<div class="mobile-view">
			<div class="main-container d-flex flex-column justify-content-center">
				<p class="text-center text-white mobile-head-text">All your invoices at your fingertips</p>
				...
				<div class="pt-4 pb-3">
					<p class="bold text-white text-center fn14">Save time and work smarter, turn your skills into recurring revenue</p>
				</div>
				<div class="apps-wrapper d-flex align-items-center justify-content-center my-1">
					<a href="https://apps.apple.com/in/app/way2work-mobile/id1551942079" target="_blank">
						<div class="apps-icon">
							...
							<div class="text-white ms-2">
								<p class="mb-1">Download on the</p>
								<span class="d-block bold">App Store</span>
							</div>
						</div>
					</a>
					...
					<a href="https://play.google.com/store/apps/details?id=com.micrasolution.way2WorkMobile" target="_blank">
						<div class="apps-icon ms-2">
							...
							<div class="text-white ms-2">
								<p class="mb-1 text-uppercase">Get it on</p>
								<span class="d-block bold">Google Play</span>
							</div>
						</div>
					</a>
				</div>
				<div class="cursor-pointer" @click="hideShowSplash">
					<p class="text-white text-center bold mt-md-4 mt-5">Continue using desktop version</p>
				</div>
			</div>
		</div>
	</section>
