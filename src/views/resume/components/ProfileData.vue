					...
					<form class="theme-input">
						<div class="form-row">
							...
							<div class="form-group col-12">
								...
								<textarea class="form-control" id="updateProfessionalSummary" :placeholder="
									t('validation.enterField', {
										field: 'fieldList.pro_summary',
									})
								" @input="summaryField.handleChange" @blur="summaryField.handleBlur" :value="summaryField.value"></textarea>
