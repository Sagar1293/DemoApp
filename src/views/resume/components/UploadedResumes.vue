	...
	<div class="my__resumes">
		<div class="payment-pill-header">
			...
			<ToolTip :title="t('toolTip.addNewResume')">
				<div class="pph-right">
					<button class="btn-common btn-red" type="button" @click="showAddResumeModal = true">+ {{
							t('common.add')
					}}</button>
				</div>
			</ToolTip>
		...
		<new-data-table :data="resumeList" sst pagination search @search="updateSearchQuery" :total="totalResume"
			:max-items="maxItemsPerPage" @change-page="handleChangePage" @sort="handleSort" class="large-table">
			<template #header>
				<div class="select__limit d-flex align-items-center">
					...
					<div class="dropdown mx-2">
						<a class="
									...
									tbl-drop
								" href="#" id="navbarDropdownResume" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							{{ maxItemsPerPage }}
						</a>
						...
						<div class="d-flex align-items-center justify-content-center">
							...
							<ToolTip :title="t('toolTip.downloadResume')">
								<a @click="viewSeekerContractDetail(tr.file_path)" class="grey-edit">
									<!-- :href="tr.file_path" title="Resume Download" download   -->
		...
		<div>
			<new-data-table :data="resumeList" sst pagination search @search="updateSearchQuery" :total="totalResume"
				:max-items="maxItemsPerPage" @change-page="handleChangePage" class="responsive-table">
				<template #header>
					<div class="select__limit d-flex align-items-center">
						<span>{{ t('invoiceList.show') }}</span>
						<div class="dropdown mx-2">
									...
									<new-tb-tr>
										...
										<new-tb-td class="resume__actions">
											<div class="d-flex align-items-center justify-content-end">
												<!-- resume download -->
												<ToolTip :title="t('toolTip.downloadResume')">
													<a :href="tr.file_path" title="Resume Download" download
														class="grey-edit">
														<FontAwesomeIcon :icon="downloadIcon" />
													</a>
												</ToolTip>
