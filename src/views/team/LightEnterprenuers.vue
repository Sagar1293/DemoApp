<template>
	...
	<div class="job__seekers_application card-space">
		...
		<div class="payment-pill-header mb-3">
			...
			<div class="pph-left">
				<h5 class="title-lg">
					{{ t('jobProposal.LightEnterpreneurs') }}
				</h5>
			</div>
		</div>
		...
		<div class="spacing-table large-table">
			<div class="table-width">
				<div class="spacing-table-head">
					...
					<span class="w-100 text-center">{{ t('jobProposal.seekForgig') }}</span>
					<span class="w-100 text-center">{{ t('jobProposal.resume') }}</span>
			...
			<div v-if="jobSeekerProposalList.length > 0">
				<div :class="`invoice__row ${proposalStatus(item)}`" :key="i" v-for="(item, i) in jobSeekerProposalList">
					<span class="font border-right w-100 me-md-2 d-flex align-items-center">
						...
						<!-- <div class="light-enterpreneur">
							@/assets/images/member-img.png
							<img :src="item.file_path" alt="img" class="img-fluid icon-ing" />
						</div> -->
					...
					<!-- <span
					class="font border-right w-100 me-2 d-flex align-items-center"
				>
					{{ item.job?.job_title }}
				</span> -->
					...
					<span class="font border-right w-100 me-md-2 d-flex align-items-center justify-content-center">
						{{ item.jobSeeker.send_job_alert == true ? 'Yes' : 'No' }}
					</span>
						...
						<div class="border-padding">
							<div v-if="i == tableIndex" class="table-border">
								<div class="d-flex align-items-center px-sm-4 px-2 py-3 border-bottom bg-white">
									<span class="w-100 text-xs">{{ t('jobProposal.lightEnterpreneurName') }}</span>
									<div class="w-100 me-md-2 d-flex align-items-center">
								...
								<div class="d-flex align-items-center px-sm-4 px-2 py-3 bg-white">
									<span class="w-100 text-xs">{{ t('jobProposal.applicationDate') }}</span>
								...
								<div class="d-flex align-items-center px-sm-4 px-2 py-3 bg-white">
									...
									<span class="w-100">
										<div class="tbl-status">
											<button class="tbl-action grey-edit" @click="viewSeekerRatingDetail(item.id)">
												<FontAwesomeIcon :icon="viewIcon" style="text-align: 'center'" />
											</button>
										</div>
									</span>
...
export default {
	...
	setup() {
		document.title = 'Light Entrepreneurs - Way2Work';
		// refs
		const page = ref(1);
