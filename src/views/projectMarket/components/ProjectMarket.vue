	...
	<section class="find-section">
		<div class="container">
			<div class="find">
				...
				<button class="btn btn-find" @click="findGigs">{{ t('jobMatching.findGigs') }}</button>
			</div>
		</div>
	</section>
									...
									<div class="card-text-btn">
										<div class="card-texts">
											...
											<p class="location-time">
												...
												<span>&bull;</span> {{ t('jobMatching.fullTime') }}
											</p>
										</div>
										<!-- <button class="btn-common btn-red">
											Apply for this Gig
										</button> -->
							...
							<div class="d-flex align-items-center justify-content-end mt-2">
								<div class="d-flex">
									<div class="mr-1 cursor-pointer">
										...
										<ShareNetwork
											network="facebook"
											:url="`https://way.way2work.ee:3002/${projectDetails.id}/${projectDetails.job_slug}`"
									...
									<!-- <div class="mr-1 cursor-pointer">
										<img src="@/assets/images/twitter-icon.png" alt="err" />
									</div>

									<div class="mr-1 cursor-pointer">
										<img src="@/assets/images/google-icon.png" alt="err" />
									</div>

									<div class="mr-1 cursor-pointer">
										<img src="@/assets/images/wp-icon.png" alt="err" />
									</div>

									<div class="cursor-pointer">
										<img src="@/assets/images/plus-icon.png" alt="err" />
									</div> -->
								</div>
							</div>
						</div>
								...
								<div class="cards-details">
									<div class="row">
										<div class="col-sm-6">
											...
											<div class="text-cards">
												<p class="text-head">{{ t('projectMarketPage.duration') }}:</p>
												<p class="card-texts">
													<!-- One Month -->
													{{ projectDetails.job_duration || '-' }}
													{{ t('projectMarketPage.month') }}
												</p>
											</div>
										</div>
										<div class="col-sm-6">
...
<script>
// import MarketSidebar from '@/views/projectMarket/components/edit/MarketSidebar.vue';
// import MarketContent from '@/views/projectMarket/components/edit/MarketContent.vue';
...
export default {
	...
	setup() {
		document.title = 'Project Market - Way2Work';
		// ref
