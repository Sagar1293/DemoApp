			...
			>
				<template #header>
					<div class="select__limit">
						...
						<span class="me-sm-3">{{ t('invoiceList.entries') }}</span>
						...
						<!-- <div class="form-group col-xl-4 col-lg-6"></div> -->
					</div>
				</template>
				...
				<template #thead>
					...
					<!-- <new-tb-th>Show Invoice</new-tb-th>
							...
							<div v-if="!tr.approved" class="d-flex align-items-center justify-content-center">
								<span v-if="tr.mark_as_wrong">
									<ToolTip :title="t('toolTip.markAsWrong')">
										<button class="tbl-action grey-edit-grey" @click="updateMarkAsWrong(tr.id, true)">
											...
											<new-tb-td>
												<div v-if="!tr.approved" class="d-flex align-items-center justify-content-start">
													<span v-if="tr.mark_as_wrong">
														...
														<ToolTip :title="t('toolTip.markAsWrong')">
															<button class="tbl-action grey-edit-grey" @click="updateMarkAsWrong(tr.id, false)">
																<FontAwesomeIcon :icon="thumbsDown" style="text-align: 'center'" />
															</button>
														</ToolTip>
													</span>
												...
												<div v-else class="d-flex align-items-center justify-content-start">
													<!-- <button class="tbl-action red-close" @click="deleteInvoice(tr.id)" :disabled="tr.approved">
														<FontAwesomeIcon :icon="deleteIcon" />
													</button>
													<button class="tbl-action grey-edit ml-2" @click="editInvoice(tr.id)" :disabled="tr.approved">
														<FontAwesomeIcon :icon="editIcon" />
													</button> -->
													<ToolTip :title="t('toolTip.markAsCredited')">
														<button class="tbl-action grey-edit-grey">
...
// console.log(currencyConverture,'============');
...
export default {
	...
	setup() {
		...
		if (userTypeInfo.value == 'jobseeker') {
			document.title = 'Invoicing - Way2Work';
		} else {
			document.title = 'All invoices - Way2Work';
		}
		/**
		 * Methods
		 * *******************************************************************
