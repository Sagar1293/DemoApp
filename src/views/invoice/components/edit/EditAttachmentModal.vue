		...
		<div class="model">
			...
			<div class="large-tables">
				<div class="select-file">
					...
					<!-- <div class="invoice-pd add-row d-flex align-items-center justify-content-between plus-border-text">
						<div class="pph-left">
						...
						<div class="plus" @click="addReceiptDetail">
									...
									<div class="border-padding">
										<div v-if="i == tableIndex" class="table-border">
											<new-tb-tr>
												...
												<new-tb-td
													><div class="product-width w-25">
														<input type="text" min="0" v-model="tr.purchase_place" class="form-control form-model" /></div
												></new-tb-td>
											</new-tb-tr>
											<new-tb-tr>
												...
												<new-tb-td
													><div class="work-width me-2 ml-xl-0 ml-3 w-20">
														<div class="position-relative">
															<v-date-picker v-model="tr.purchase_date" :masks="{ input: 'DD.MM.YYYY' }" class="d-flex align-items-center">
																<template
																	v-slot="{
																		inputValue,
																		inputEvents,
													...
													><div class="work-width me-2 w-40">
														<div class="work py-0">
															<div class="">
																<div>
																	<div class="input-pera btn-color position-relative">
																		<drop-zone @fileDrop="file => handleContractFileChange(file, i)" class="mb-4" :isUploadButton="false" />
																		<div class="preview top-0 left-0" v-if="row.contractFile">
																			<div id="preview">
																				<div class="dz-preview dz-error dz-complete dz-image-preview dz-img-wrap">
																					<div class="dz-image">
																						<img data-dz-thumbnail="" alt="Invocie receipt file image" :src="tr.contractFilePreview" class="thumb-img" />
																					</div>
																					<div class="dz-details d-flex align-items-center">
																						<div class="dz-filename">
																							<span>
...
export default {
	...
	setup(props) {
		...
		const closeModal = () => {
			...
			editFormFieldsData.value.receiptFileField.value = receiptItemData || [];
			console.log(editFormFieldsData.value.receiptFileField.value, '<><><><><><>');
		 ...
		 */
		onMounted(() => {
			console.log(store.state.invoice.invoiceInfo, '<><><><><><><>');
			receiptItem.value = store.state.invoice.invoiceInfo.invoice_files.map(x => ({
				id: x.id,
