		...
		<div class="model">
			...
			<div>
				<div class="select-file">
					...
					<!-- multiple files -->
					<!-- <div>
						<p class="input-title">Multiple Files</p>
						<div>
							<div class="input-pera btn-color">
								<drop-zone @fileDrop="handleInvoiceMultiFile" />
							</div>
						</div>
					
						<div class="preview" v-if="invoiceMultiFile">
							<button
								type="button"
								class="drop-close"
								@click="removeInvoiceMultiFile"
							>
							...
							<div class="dz-preview dz-image-preview">
								<div class="dz-image">
									<img
										data-dz-thumbnail=""
										alt="Invoice multi file image"
										:src="invoiceMultiFilePreview"
										class="thumb-img"
									/>
								</div>
					...
					<div class="form-row account__form">
						...
						<div class="form-group dropdown select-employee col-xl-2 col-lg-6">
							<div>
								...
								<ul
									class="dropdown-menu"
									aria-labelledby="dropdownMenuButtonVatAria"
								>
									<li>
