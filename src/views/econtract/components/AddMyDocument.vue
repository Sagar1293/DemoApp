						...
						<div class="form-row">
							...
							<div class="form-group col-12">
								...
								<div class="drop-container">
									<!-- drop zone component -->
									<drop-zone @fileDrop="handleContractFileChange" class="mb-4" :isUploadButton="false" />

									<!-- contract file - error -->
									<p class="contract_file_error text-center text-danger">
...
export default {
	...
	setup(props, { emit }) {
		...
		const submitForm = handleSubmit(async values => {
			...
			await store.dispatch('econtract/addEContractFile', formData).then(() => {
