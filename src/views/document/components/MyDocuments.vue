					...
					<new-tb-td>
						<span :class="[isDocumentExpire(tr) ? 'text-red' : 'text-yellow']">
							<span>
								...
								{{ isDocumentExpire(tr) ? 'Document Expired' : 'Document Not Expired' }}
							</span>
						</span>
					</new-tb-td>
					<new-tb-td>
						<div class="d-flex align-items-center justify-content-center">
							<ToolTip :title="t('toolTip.viewDocument')">
								...
								<!-- <button class="tbl-action grey-edit" @click="showAddTeamNameModal = true">
									<FontAwesomeIcon :icon="viewIcon" style="text-align: 'center'" />
								</button> -->
							</ToolTip>
	...
	setup() {
		...
		const viewSeekerDocument = link => {
			const checkExtenation = link
				...
				.pop()
				.trim();
			console.log(checkExtenation, 'checkExtenation');
