<template>
	...
	<section class="banner-image banner-section d-flex justify-content-center align-items-center">
		...
		<div class="login-box">
			...
			<span class="forgot d-flex align-items-center justify-content-center my-4">{{ t('common.sign_in_as_a_partner') }}</span>
			<form>
...
export default {
	...
	setup() {
		...
		const showEmail = async () => {
			localStorage.setItem('changePassUserTyep', 'company');
