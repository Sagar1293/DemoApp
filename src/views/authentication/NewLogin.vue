<template>
	...
	<section class="banner-image banner-section d-flex flex-column justify-content-center align-items-center">
		...
		<div class="login-box">
			...
			<a class="forgot d-flex align-items-center justify-content-center my-4" href="./forgot-password.php">Sign In</a>

			<div class="form-group">
				<a class="btn-common btn-red btn-block" role="button" @click="showLoginFormLe">{{ t('common.as_a_light_entrepreneur') }}</a>
			</div>
