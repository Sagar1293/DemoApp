						...
						<div class="pph-left-box">
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label for="tripName" class="company-titel"> {{ t('fieldList.tripName') }}</label>
									<input
										id="tripName"
										type="text"
										class="form-control"
							...
							<div class="row">
								...
								<label for="firstName" class="company-titel pl-1">{{ t('leInvoice.addInvoice.extras') }} </label>
								<div class="ml-3">
									<div class="row">
										...
										<div class="col-md-4 form-check form-checkbox">
											...
											<label class="form-check-label extras-font checkbox-left-padding white-space" for="drivenRoughTerrain">
												{{ t('leInvoice.addInvoice.roughTerrain') }}
											</label>
										</div>
				...
				<div class="invoice-grey-sec">
					<div class="row">
						...
						<!-- <div class="col-xl-3 col-lg-6 col-12 form-group">
							<label for="addShowInTeam" class="company-titel">Show In Team</label>
							<div class="select-employee">
								<Multiselect
									id="addShowInTeam"
									class="form-group"
						...
						<div class="col-xl-3 col-lg-6 col-12 form-group">
							...
							<div>
								...
								/>
								<!-- @click="removelunchCompensationField" -->
							</div>
						</div>
			...
			<div class="invoice-pd invoice-receipt">
				<div class="row" v-for="(row, index) in receiptItem" :key="row">
					<div class="d-flex justify-content-between">
						<div class="pph-left">
							<h5 class="title-lg mb-2">{{ t('addWorkDetail.receipts') }}</h5>
						</div>
					...
					<div class="col-xl-6 col-6 form-group">
						<label for="addTeamPlaceOfPurchase" class="input-title">{{ t('leInvoice.viewInvoice.placeOfPurchase') }}</label>
					...
					<div class="col-xl-6 col-6 theme-input">
						<label for="teamDateofPurchase" class="input-title">{{ t('leInvoice.viewInvoice.dateOfPurchase') }}</label>
						<v-date-picker
					...
					<div class="form-group col-xl-6 col-12">
						<p class="input-title">{{ t('invoiceData.attachments') }}</p>
						<div class="">
							<div>
...
export default {
	...
	setup() {
		document.title = 'Add Work Detail - Way2Work';
		// ref
		...
		const submitForm = handleSubmit(async values => {
			...
			await store.dispatch('workDetail/addWorkDetails', values).then(({ data }) => {
		...
		// const removelunchCompensationField = event => {
		// 	if (event) {
