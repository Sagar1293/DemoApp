<template>
	<div class="paymentsharingList mt-3">
			...
			<div class="daily-work-col">
				...
				<div v-for="(tMem, index) in teamMembers" :key="index">
					<div class="details-content text-center">
						...
						<!-- <div class="role-member">
							<div class="w-20 h-20 mx-auto">
								<img :src="require(`@/assets/images/${getTeamDetails.createdById === tMem?.id ? 'leader-icon.svg' : 'member-icon.svg'}`)" class="w-100 h-100" alt="err" />
							</div>
						</div> -->
		...
		<div class="overflow-auto">
			<div class="bottom-header min-w-auto d-lg-flex align-items-center justify-content-between mt-3 mb-4">
				<div class="pph-left mb-lg-0 mb-2">
