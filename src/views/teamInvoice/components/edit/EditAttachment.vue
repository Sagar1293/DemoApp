						...
						<div class="daily-work-col">
							...
							<div class="pb-3">
								...
								<!-- <div class="text-center pt-2 pb-2">
									<ToolTip :title="t('toolTip.updateAttachments')">
										<button class="btn-common btn-red px-3 py-2" @click="closeModal">
											{{ t('invoiceData.updateAttachments') }}
										</button>
									</ToolTip>
								</div> -->
							</div>
...
export default {
	...
	setup(props) {
		...
		// 	Swal.fire({
		// 		title: 'Are you sure?',
		// 		text: 'You want to update attachment ?',
		// 		icon: 'success',
		 ...
		 */
		onMounted(() => {
			// console.log(store.state.invoice.invoiceInfoDetails, '<><><><><><><>');
			// if (store.state.invoice?.invoiceInfo?.invoice_files) {
