<template>
	<div class="invoice_form mt-2">
		...
		<div class="payment-pill-header">
			...
			<!-- <div class="pph-right">
				<ToolTip title="Edit Team Attachments">
					<button class="btn-common btn-red" @click="toggleAttachmentModal">
		...
		<div class="pph-left-box">
			<div class="company-content">
				...
				<!-- payment terms -->
				<!-- <div class="company-text company-text-item">
					<p class="company-titel">Payment terms</p>
					<p class="company-input days-net rounded-md">
						<input
							type="number"
							min="0"
							id="payment_terms"
							@input="formFieldsData.paymentTermField.handleChange"
							@blur="formFieldsData.paymentTermField.handleBlur"
				...
				<div class="company-text company-text-item">
					...
					<div class="w-100">
						<div class="company-input input-date pr-2 rounded-md">
							<!-- formFieldsData.dueDateField.value -->
				...
				<div class="company-text company-text-item">
					...
					<!-- <div class="pph-right">
						<router-link to="/worked-details/add">
							<button class="plus ml-auto mt-md-0 mt-2">
				...
				<!-- Selected date -->
				<!-- <div class="company-text company-text-item">
					<p class="company-titel">Select date</p>
					...
					<p class="company-input input-date mt-md-0 mt-2">
						<v-date-picker
				...
				<!-- <p class="text-danger">
					{{ formFieldsData.workEndDateField.errorMessage }}
				</p> -->

				<!-- notice period -->
				<div class="company-text company-text-item">
					<p class="company-titel">{{ t('leInvoice.addInvoice.noticePeriod') }}</p>
					<p class="w-100">
						<input
							type="text"
				...
				<!-- tax -->
				<!-- <div class="company-text company-text-item">
					<p class="company-titel">Tax (Vero%)</p>
	...
	<Suspense v-if="showAddEmployerModal.value">
		<template #default>
			<EditAttachmentModal v-model:isModalShow="showAddEmployerModal" :formFields="formFieldsData" />
		</template>
	</Suspense>
</template>
...
import EditAttachmentModal from '@/views/teamInvoice/components/edit/EditAttachmentModal';
...
export default {
	...
	setup(props) {
		...
		// const removePaymentTerms = event => {
		// 	if (event) {
