<template>
	<div class="paymentsharingList mt-3">
		...
		<div class="d-flex align-items-center justify-content-between mb-3">
			<div>
				<h5 class="title-lg">{{ t('teamInvoiceList.paymentSharing') }}</h5>
			</div>
		</div>
		<p class="pb-2">{{ t('teamInvoiceList.thisPayment') }}</p>
			...
			<div class="daily-work-col">
				...
				<div class="details-head text-center d-flex align-items-center">
					<div class="member-name">
						<p class="details-head-text text-start">{{ t('teamInvoiceList.memberName') }}</p>
					</div>

					<div class="role-member">
						<p class="details-head-text">{{ t('teamInvoiceList.Role') }}</p>
					</div>

					<div class="email-address">
						<p class="details-head-text">{{ t('teamInvoiceList.emailAddress') }}</p>
					</div>

					<div class="share-value">
						<p class="details-head-text">{{ t('teamInvoiceList.payableAmount') }}</p>
					</div>

					<div class="share-value">
						<p class="details-head-text">{{ t('teamInvoiceList.Share') }}</p>
					</div>

					<div class="Tax-value">
						<p class="details-head-text">{{ t('teamInvoiceList.taxPercentage') }}</p>
					</div>

					<div class="allowances">
						<p class="details-head-text">{{ t('teamInvoiceList.Allowances') }}</p>
					</div>
					<div class="payment">
						<p class="details-head-text">{{ t('teamInvoiceList.willBePaid') }}</p>
					</div>
					<div class="payment">
						<p class="details-head-text">{{ t('teamInvoiceList.Actions') }}</p>
					</div>
				</div>
					...
					<div class="opne-toggle p-3 border-top border-bottom" v-if="index === expandRowIndex">
							...
							<div class="row no-gutters">
								<div class="details-content border rounded-bottom" v-for="(tMW, wI) in tMem?.seeker?.work_hours || []" :key="wI">
									...
									<div class="description-width">
										...
										<span v-else class=""> {{ t('teamInvoiceList.noDescription') }} </span>
									</div>
						...
						<div class="overflow-auto">
							<div class="bottom-header d-flex align-items-center justify-content-between mt-3">
								<div class="pph-left">
									<h5 class="text-white">{{ t('leInvoice.addInvoice.le') }}</h5>
								</div>
								<div class="d-flex align-items-center ml-md-auto">
									<div class="mr-5 text-white">
										<p class="text-md-fw">{{ t('teamInvoiceList.payableAmount') }}</p>
						...
						<div class="form-check form-checkbox mt-4">
							...
							/>
							<label class="form-check-label extras-font ml-2" for="paymentdebugcalculation"> {{ t('leInvoice.addInvoice.debugCal') }} </label>
						</div>
								...
								<div class="total mt-3">
									...
									<div class="text-end margin-top-5">
										...
										<span class="text-xs d-block"
											>({{ t('teamInvoiceList.taxPercentage') }} ({{ tMem.PersonalTax }}%) {{ t('common.of') }} {{ t('leInvoice.addInvoice.gross_salary') }})</span
										>
									</div>
									...
									<div class="text-end margin-top-5">
										<div class="total-excl">
											<p class="text-total">
												...
												{{ t('leInvoice.addInvoice.grossAfterTax') }}
											</p>
									...
									<div class="text-end margin-top-5">
										<div class="total-excl">
											...
											<p class="text-prize">€ {{ calculateMISBCommision(index).toFixed(2) || 0 }}</p>
										</div>
									...
									<div class="text-end margin-top-5">
										<div class="total-excl">
											<p class="text-total">
												<!-- Quickpay Commission Amount -->
												{{ t('leInvoice.addInvoice.quickpayAmt') }}
											</p>
											<p class="text-prize">€ {{ calculateQuickPayCommision(index).toFixed(2) || 0 }}</p>
										</div>
										<span class="text-xs d-block"
											>({{ t('leInvoice.addInvoice.quickpayCommission') }}({{ tMem.quickpayPercentage }}%) {{ t('common.of') }}
											{{ t('leInvoice.addInvoice.vatAddedValue') }})</span
										>
									</div>
									...
									<div v-if="index == tableIndex" class="table-border">
										<div class="payment_table">
											<new-tb-tr class="top_border">
												<new-tb-th>{{ t('teamInvoiceList.memberName') }}</new-tb-th>
												<new-tb-td>
													<div class="product-no">
														<div class="d-flex align-items-center">
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.Role') }}</new-tb-th>
												<new-tb-td>
													<div class="role-member">
														<span v-if="getTeamDetails.createdById === tMem?.seekerId">
															<ToolTip :title="t('toolTip.leader')">
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.emailAddress') }}</new-tb-th>
												<new-tb-td>
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.payableAmount') }}</new-tb-th>
												<new-tb-td>
													<div class="email-address mr-2 text-break">
														<div>
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.Share') }}</new-tb-th>
												<new-tb-td>
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.taxPercentage') }}</new-tb-th>
												<new-tb-td>
													<div class="Tax-value">
														<div class="py-0 d-flex align-items-center text-center">
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.Allowances') }}</new-tb-th>
												<new-tb-td>
													<div class="allowances">
														<div class="py-0 d-flex align-items-center">
															<p class="pl-2">€ {{ Number(tMem.total_compensation).toFixed(2) || 0 }}</p>
											...
											<new-tb-tr>
												<new-tb-th>{{ t('teamInvoiceList.willBePaid') }}</new-tb-th>
												<new-tb-td>
													<div class="payment">
														<div>
											...
											<new-tb-tr class="">
												<new-tb-th>{{ t('teamInvoiceList.Actions') }}</new-tb-th>
												<new-tb-td>
													<div class="actions d-flex justify-content-center align-items-center">
														<!-- expand work detail -->
													...
													<new-tb-tr>
														...
														<new-tb-td>
															<div class="description-width">
																...
																<span v-else> {{ t('teamInvoiceList.noDescription') }} </span>
															</div></new-tb-td
														>
													</new-tb-tr>
													<new-tb-tr>
												...
												<div class="bottom-header d-lg-flex align-items-center justify-content-between my-3">
													...
													<div class="d-sm-flex align-items-center ml-md-auto">
														<div class="mr-lg-5 mr-4 mb-md-0 mb-1 text-white">
															<p class="text-sm-fw">{{ t('teamInvoiceList.payableAmount') }}</p>
												...
												<div class="col-lg-9 col-12 ml-auto">
													<div class="total mt-3">
														...
														<div class="text-end margin-top-5">
															...
															<span class="text-xs d-block"
																>({{ t('teamInvoiceList.taxPercentage') }} ({{ tMem.PersonalTax }}%) {{ t('common.of') }}
																{{ t('leInvoice.addInvoice.gross_salary') }})</span
															>
														</div>
			...
			<div class="bottom-header d-lg-flex align-items-center justify-content-between my-3">
				...
				<div class="d-sm-flex align-items-center ml-md-auto flex-md-wrap flex-wrap">
					<div class="mr-5 text-white mb-md-0 mb-1">
						...
						<!-- {{ Number(invoiceTotal).toFixed(2) || 0.0 }} -->
					</div>
		...
		<p class="pt-2 border-bottom pb-3">
			{{ t('leInvoice.addInvoice.teamInvoiceNote') }}
		</p>

		<div class="text-right mt-2">
			<h5 class="title-sm fw-bolder">{{ t('leInvoice.addInvoice.leftToShare') }}</h5>
...
export default {
	...
	setup(props) {
		...
		const calculateGrossSalary = computed(() => index => store.getters['teamInvoice/calculateGrossSalaryOfSeeker'](index, props.vat));
