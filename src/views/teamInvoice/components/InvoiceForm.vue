	...
	<div class="invoice_form">
		...
		<div class="pph-left-box" :class="{ showMore: isCollapseOpen }">
			<div class="company-content">
				...
				<!-- Selected date -->
				<div class="company-text company-text-item">
					<p class="company-titel">{{ t('leInvoice.addInvoice.selectDate') }}</p>
...
import AddAttachmentModal from '@/views/teamInvoice/components/AddAttachmentModal';
...
export default {
	...
	setup(props) {
		...
		const onQuickPayFiled = () => {
			...
			console.log(formFieldsData.value.quickPayField.value, '<><><<><>');
