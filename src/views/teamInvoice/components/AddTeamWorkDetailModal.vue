												...
												<div class="d-flex flex-column justify-content-center h-100">
													<div class="form-check form-checkbox">
														<input
															...
															type="checkbox"
															id="teamTransportedHeavyLoad"
															:checked="transportedHeavyLoad"
															:value="transportedHeavyLoad.value"
															:v-model="transportedHeavyLoad.value"
															@click="onTransported($event)"
														/>
														<label class="form-check-label extras-font" for="teamTransportedHeavyLoad"> Transported heavy load </label>
													</div>
													...
													<div class="form-check form-checkbox">
														<input
															...
															id="teamDrivenRoughTerrain"
														/>
														<label class="form-check-label extras-font" for="teamDrivenRoughTerrain"> Driven in rough terrain </label>
													</div>
													...
													<div class="form-check form-checkbox">
														<input
															...
															id="teamVehicleSubClass"
														/>
														<label class="form-check-label extras-font" for="teamVehicleSubClass"> Trailer </label>
													</div>
												</div>
											</div>
										</div>
	...
	setup(props, { emit }) {
		...
		const submitForm = handleSubmit(async (values) => {
			...
			if (invoiceWorkDetails.length) {
				...
				workDetailData.indexIdField = props.indexIdField ?? 0;
		...
		const onTransportedWorkload = () => {
			...
			console.log(transportedWorkload.value, 'transportedWorkload.value');
		...
		const fetchInvoiceWorkDairies = () => {
			...
			let dataWorkDetail = checkExistingWorkDetails[props.indexIdField];
			...
			setValues({
				...
				distance: dataWorkDetail.distance == null ? null : dataWorkDetail.distance,
				...
				date: dataWorkDetail.date == null ? null : dataWorkDetail.date,
			});
		};
