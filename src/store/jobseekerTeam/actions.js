...
export default {
	...
	addSeekerTeamMember: async ({ commit }, { payload, id }) => {
		...
		try {
			const res = await axios.post(
				`/jobseeker/seeker-team/add-member/${id}`,
				payload,
			);
	...
	deleteJobseekerTeamMember: async ({ commit }, { seekerId, teamId }) => {
		...
		try {
			const res = await axios.delete(
				`/jobseeker/seeker-team/${seekerId}/${teamId}`,
			);
	...
	deleteinvitedUser: async ({ commit }, { teamId, id }) => {
		...
		try {
			const res = await axios.delete(
				`/jobseeker/seeker-team/new-member/${teamId}/${id}`,
			);
	...
	userReSendEmail: async ({ commit }, { payload, id }) => {
		...
		try {
			const res = await axios.post(
				`/jobseeker/seeker-team/resend-invitation/${id}`,
				payload,
			);
